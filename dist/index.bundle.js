...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index.js */ \"./src/index.js\");\n\r\n\r\nconst refreshLeaderboard = async () => {\r\n  const response = await fetch(\r\n    'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/BxXNm40rTdIjhpN9YGnO/scores',);\r\n    const scoreText = await response.text();\r\n    const score = JSON.parse(scoreText);\r\n    score.result.forEach((player) => {\r\n      if (player.length === 0) {\r\n        _index_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].style.border = 'none';\r\n      } else {\r\n        _index_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].style.border = '2px solid rgb(36, 1, 1)';\r\n        _index_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].innerHTML += `<li>\r\n        ${player.user}  :  ${player.score}</td>\r\n        </li>`;\r\n      }\r\n    });\r\n  };\r\n  \r\n  /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (refreshLeaderboard);\n\n//# sourceURL=webpack://webpack/./src/modules/refresh.js?");
